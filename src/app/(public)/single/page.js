...
const Single = () => {
  ...
  const project = {
    ...
    hat: "Guia de Viagens",
    title: "Sistema FAROL",
    excerpt: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam non diam sit amet enim euismod blandit luctus lacinia lorem. Vestibulum ultricies est turpis, ut pulvinar lorem tempor a. Fusce eros nisl, molestie id sapien in, aliquam consequat enim. Nam id ipsum ultricies ex vulputate condimentum.",
    link: {
      url: '/',
      target: '_blank',
      title: 'Acessar'
            ...
            <div className="w-full flex flex-col gap-[1.5rem] pb-[3rem] border-b border-[#FFFFFF33] lg:flex-row lg:items-end lg:gap-[5rem]">
              <div className="lg:min-w-[41.125rem]">
                ...
                <div className="flex items-center gap-[2.0625rem] mb-[1rem] lg:gap-[4rem]">
                  ...
                  <a href={project?.link?.url} className="text-gray-200 bg-white-10 hover:bg-primary menu-section flex items-center py-2 px-4 rounded-3xl gap-x-2 flex-none duration-500" title={project?.link?.title} target={project?.link?.target}>
