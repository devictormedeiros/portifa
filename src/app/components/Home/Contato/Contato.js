...
const Contato = () => {
  ...
  const onSubmit = (data) => {
    console.log(data);
    setIsSuccess(true); // Exibe mensagem de sucesso ao enviar
  };
        ...
        <div className="sec-contato-body flex justify-between">
          <div className="w-2/6">
            <p>
              ...
              diam sit amet enim euismod blandit luctus lacinia lorem.
              Vestibulum ultricies est turpis, ut pulvinar lorem tempor a. Fusce
              eros nisl, molestie id sapien in, aliquam consequat enim. Nam id
              ipsum ultricies ex vulputate condimentum.
            </p>

            <p>
              Etiam non diam sit amet enim euismod blandit luctus lacinia lorem.
              Vestibulum ultricies est turpis, ut pulvinar lorem tempor a. Fusce
              eros nisl, molestie id sapien in, aliquam consequat enim. Nam id
              ipsum ultricies ex vulputate condimentum.
            </p>
            <div className="social-media flex flex-wrap gap-6 items-center mt-8">
              <a href="#" className="social-media-icon flex items-center gap-2">
                <svg
                  width="34"
                  height="34"
                  viewBox="0 0 34 34"
