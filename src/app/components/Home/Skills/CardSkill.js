const CardSkill = ({ titulo, subtitulo, ano, texto }) => {
    return (
        <article className="card-skills flex flex-col gap-6 md:gap-8 duration-300 rounded-2xl p-6 md:p-10 cursor-pointer">
            ...
            <p className="text-white-70 content-text">{texto}</p>
        </article>
    );
};
